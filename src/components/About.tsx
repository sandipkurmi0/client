...
const About: FC = () => {
  const DEVELOPER = "Sandip";

  return (
    <div className="p-4 text-gray-600">
      <header className="bg-white shadow-sm w-full  top-0 ">
        <div className="max-auto  px-8 py-4 bg-white">
          <div className="text-center">
            <div className="app-name ">
              <h1 className="text-black text-2xl font-bold">Budget</h1>
              <span className="text-xs">An app by {DEVELOPER}</span>
            </div>
          </div>
        </div>
      </header>
